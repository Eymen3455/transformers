...
MBART_TINY = "facebook/mbart-large-cc25"
...
class TestAll(TestCasePlus):
    ...
    def test_seq2seq_dataset_truncation(self, tok_name):
        ...
        src_lang, tgt_lang = "tr_TR", "tr_TR"  # ignored for all but mbart, but never causes error.
    ...
    def test_dataset_kwargs(self, tok_name):
        tokenizer = MBartTokenizer.from_pretrained(tok_name, use_fast=False)
        if tok_name == MBART_TINY:
            train_dataset = Seq2SeqDataset(
                tokenizer,
